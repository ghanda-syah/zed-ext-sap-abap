...
(loop_at_statement 
  subject: (identifier) @constant.builtin
  (#match? @constant.builtin "^([sS][cC][rR][eE][eE][nN])")
)
(modify_statement 
  subject: (identifier) @constant.builtin
  (#match? @constant.builtin "^([sS][cC][rR][eE][eE][nN])")
...
; ABAP SQL
(sql_delete_statement target: (identifier) @type)
...
(sql_modify_statement
  target: (dynamic_spec value: (identifier) @type))
(sql_update_statement target: (identifier) @type)
